...
// Admin (Menggunakan alias middleware 'admin')
Route::middleware(['auth', 'admin'])
    ...
    ->group(function () {
        ...
        Route::get('/pengembalian/create/{peminjaman_id}', [AdminController::class, 'createPengembalian'])
            ->name('pengembalian.create');

        Route::post('/pengembalian/{peminjaman_id}', [AdminController::class, 'storePengembalian'])
...
// Petugas (Menggunakan alias middleware 'petugas')
...
// Peminjam (Menggunakan alias middleware 'peminjam')
